  ...
  <div class="app-container">
    ...
    <el-table :height="tableMaxHeight" stripe border v-loading="loading" :data="tableDataList"
      ...
      <el-table-column type="selection" width="55" align="center"/>
          ...
          <el-table-column prop="name" :show-overflow-tooltip="true" width="150" label="姓名">
          </el-table-column>
      ...
      <div style="width: 80%;margin-left: 50px;">
        <el-form ref="addFormRef" :model="addForm" :rules="rules" label-width="120px">
              ...
              <el-form-item label="姓名" prop="name">
                <el-input v-model="addForm.name" placeholder="姓名" auto-complete="off" maxlength="50" show-word-limit style="width: 100%;"></el-input>
              </el-form-item>
